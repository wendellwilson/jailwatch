...
class StateDatasetRouter(object):
    ...
    def _db_name(self, model):
        return 'jailwatch_{}'.format(model._meta.app_label)

    def _db_name_from_label(self, app_label):
        return 'jailwatch_{}'.format(app_label)
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        # scenarios:
        #
        # default           jailwatch_nc    False
        # default           jailwatch_admin True
        # jailwatch_nc  jailwatch_admin False
        # jailwatch_nc  jailwatch_nc    True
        #
